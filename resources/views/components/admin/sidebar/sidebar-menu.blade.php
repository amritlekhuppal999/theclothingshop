        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent " data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/products*')) ? "menu-open" : ""}} ">
                ...
                <ul class="nav nav-treeview">
                    ...
                    {{-- Manage Variants --}}
                    <li class="nav-item">
                        <a href="{{ safe_route("products-variants") }}" class="nav-link {{ (request()->is('admin/products-variants') || request()->is('admin/products-variants/*')) ? "active" : ""}}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Manage Variants</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/featured-products*')) ? "menu-open" : ""}}">
                <a href="#" class="nav-link {{ (request()->is('admin/featured-products*')) ? "active" : ""}}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ safe_route("feature-product-form") }}" class="nav-link {{ (request()->is('admin/featured-products-add') ) ? "active" : ""}}">
                            <i class="far fa-circle nav-icon"></i>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ safe_route("featured-products-view") }}" class="nav-link {{ (request()->is('admin/featured-products-view') ) ? "active" : ""}}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>View Featured</p>
                        </a>
                    </li>
            ...
            {{-- Banner Images --}}
            <li class="nav-item">
                <a href="{{ safe_route("update-banner-images") }}" class="nav-link {{ (request()->is('admin/update-banner-images') ) ? "active" : ""}}">
            ...
            {{-- Logout --}}
            <li class="nav-item">
                <a href="{{ safe_route("logout-admin") }}" class="nav-link">
