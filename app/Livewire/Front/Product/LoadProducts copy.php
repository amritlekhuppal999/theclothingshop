...
class LoadProducts extends Component
{
    ...
    */
    ...
    // this is triggered from front end to load more elements.
    public function loadMore($queryParams=[]){
        // if (!empty($params)) {
    ...
    // To rerender the livewire component
    public function triggerRefresh(){
        $this->refresh = !$this->refresh; // toggling value to trigger reactivity
    }
